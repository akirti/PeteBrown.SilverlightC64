    ...
    public partial class MOS6510
    {
                ...
                case 0xd:
                    if (io_in)
                    {
                        switch ((adr >> 8) & 0x0f)
                        {
                            ...
                            case 0xa:
                            case 0xb:
                                return (byte)(_colorRam[adr & 0x03ff] & 0x0f | TheVIC.LastVICByte & 0xf0);
                            case 0xc:	// CIA 1
                    ...
                    {
                        return _characterRom[adr & 0x0fff];
                    }
        ...
        void write_byte(UInt16 adr, byte abyte)
        {
            if (adr < 0xd000)
            {
                ...
                {
                    ddr = abyte;
                    _ram[0] = TheVIC.LastVICByte;
                    new_config();
                }
                else
                {
                    pr = abyte;
                    _ram[1] = TheVIC.LastVICByte;
                    new_config();
                }
            }
            else
        ...
        void write_byte_io(UInt16 adr, byte abyte)
        {
            if (adr >= 0xe000)
            {
                ...
                switch ((adr >> 8) & 0x0f)
                {
                    ...
                    case 0xa:
                    case 0xb:
                        _colorRam[adr & 0x03ff] = (byte)(abyte & 0x0f);
                        return;
                    case 0xc:	// CIA 1
        ...
        {
            return (UInt16)(_ram[adr & 0xff] | (_ram[(adr + 1) & 0xff] << 8));
        }
