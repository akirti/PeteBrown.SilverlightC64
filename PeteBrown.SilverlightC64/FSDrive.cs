...
//#if WINDOWS
//                    else
//                        Environment.CurrentDirectory = Assembly.GetExecutingAssembly().Location;  // Not available on .NET Compact Framework
//#endif
//                }
...
//        }
        ...
        //        // Use MemoryStream instead of a temporary file's 
        //        // FileStream for compatiblity with .NET Compact 
        //        // Framework and better performance
        //        file[channel] = new MemoryStream();
